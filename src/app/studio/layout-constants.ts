...
export const STUDIO_WORKSPACE_GRID_CLASS_NAME = "relative z-10 mx-auto grid max-w-[1500px] gap-5 xl:grid-cols-[minmax(430px,0.52fr)_minmax(720px,1fr)]";
...
export const MODE_OPTION_CLASS_NAME = "flex min-h-[58px] items-center gap-3 rounded-2xl border px-3 py-2 text-left transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#d946ef]/70";
