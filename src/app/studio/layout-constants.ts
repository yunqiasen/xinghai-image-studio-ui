...
export const STUDIO_PAGE_CLASS_NAME = "relative min-h-[calc(100dvh-72px)] overflow-visible bg-[#f6f8fc] px-5 py-6 text-[#111827] sm:px-6 lg:px-8";
export const STUDIO_WORKSPACE_GRID_CLASS_NAME = "relative z-10 mx-auto grid w-full max-w-[1760px] items-start gap-6 xl:grid-cols-[minmax(680px,0.9fr)_minmax(720px,1.1fr)]";
export const EDITOR_PANEL_GRID_CLASS_NAME = "min-w-0";
export const CONTROLS_PANEL_CLASS_NAME = "rounded-[30px] border border-white/12 bg-[linear-gradient(145deg,#171626,#211b34_52%,#151525)] p-4 text-white shadow-[0_22px_70px_rgba(63,37,112,.24)] sm:p-5";
export const PREVIEW_PANEL_CLASS_NAME = "min-h-[calc(100dvh-120px)] rounded-[30px] border border-[#e6edf5] bg-white/96 p-4 text-[#111827] shadow-[0_22px_60px_rgba(15,23,42,.08)] backdrop-blur sm:p-5 xl:sticky xl:top-24";
