...
const promptTemplates: PromptTemplate[] = [
  {
    name: "真实摄影",
    prompt: "清晨自然光下的真实摄影，主体清晰，背景柔和虚化，色彩干净高级，35mm 镜头，细节丰富",
  },
  {
    name: "商业主图",
    prompt: "高端电商商业主图，产品居中，干净背景，柔和布光，质感突出，留白合理，适合广告投放",
  },
  {
    name: "动漫角色",
    prompt: "精致动漫角色设定图，清晰五官，服饰细节丰富，柔和光影，干净背景，角色一致性强",
  },
  {
    name: "漫画分镜",
    prompt: "电影感漫画分镜画面，强叙事构图，动态镜头，人物表情明确，光影层次丰富，画面干净",
  },
  {
    name: "3D 渲染",
    prompt: "高质量 3D 渲染风格，细腻材质，真实灯光，全局光照，干净构图，产品级视觉效果",
  },
  {
    name: "换背景",
    prompt: "保留主体形态和细节，替换为高级室内摄影棚背景，柔和阴影，真实融合，不改变主体比例",
  },
  {
    name: "统一角色",
    prompt: "同一角色多场景一致性生成，保持发型、服装、五官、年龄和气质一致，画风统一，适合漫画分镜",
  },
  {
    name: "高级灰调色",
    prompt: "高级灰电影调色，低饱和度，柔和对比，细腻颗粒感，安静高级的视觉氛围，构图稳定",
  },
];
                  ...
                  {Object.entries(modePricing).map(([key, item]) => {
                    ...
                    return (
                      <button
                        key={key}
                        aria-pressed={active}
                        className={`${MODE_OPTION_CLASS_NAME} ${active ? "border-[#d946ef]/80 bg-[#39164b] text-white shadow-[0_0_0_1px_rgba(217,70,239,.42),0_18px_44px_rgba(217,70,239,.18)]" : "border-white/8 bg-white/5 text-white/72 hover:border-white/16 hover:bg-white/9"}`}
